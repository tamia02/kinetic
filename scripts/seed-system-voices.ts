...
const systemVoiceMetadata: Record<string, VoiceMetadata> = {
  ...
  Advik: {
    description: "Deep and resonant Hindi voice, perfect for formal announcements",
    category: "GENERAL",
    language: "hi-IN",
  },
  Kavya: {
    description: "Soft and expressive Tamil voice, ideal for storytelling",
    category: "NARRATIVE",
    language: "ta-IN",
  },
  Rohan: {
    description: "Energetic and clear Telugu voice, great for advertisements",
    category: "ADVERTISING",
    language: "te-IN",
  },
  Saanvi: {
    description: "Polite and melodic Kannada voice, suited for information services",
    category: "CUSTOMER_SERVICE",
    language: "kn-IN",
  },
};
